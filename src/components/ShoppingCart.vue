  ...
  <table id="cart" class="table table-hover table-sm">
    <thead>
      <tr>
        ...
        <th style="width:22%" class="text-center">Subtotal + 14%vat</th>
    ...
    <tfoot>
      <tr class="d-table-row d-sm-none">
        <td class="text-center"><strong>Total Rs{{ cartValue.toFixed(0) }}</strong></td>
      </tr>
      <tr>
        <td>
        ...
        <td class="d-none d-sm-table-cell text-center"><strong>Total 2%off Rs{{ cartValue.toFixed(0)}}</strong></td>
        <td class="px-0">
...
export default {
  computed: {
    ...mapGetters(['cartItemList', 'products', 'currentUser', 'cartValue'])
  },
  components: {
  ...
  methods: {
    ...
    saveShoppingCartLocal() {
        ...
        this.addMessage({
          ...
          message: ' save your cart SucessFully'
        });
      }
    },
    checkout() {
